...
* **Урок 3.** SQL – выборка данных, сортировка, агрегатные функции
  ![lesson3_1](/source/lesson3_1.jpg)  
  * №1
...
* **Урок 4.** SQL – работа с несколькими таблицами
  ...
  * №2
  ![lesson4_2](/source/lesson4_2.jpg)  
...
* [SELECT](#Базовый-синтаксис-SQL-команды-SELECT)
* [AS](#SQL-псевдонимы)
* [WHERE](#Условный-оператор-WHERE)
* [INSERT](#Добавление-данных-оператор-INSERT)
* [CASE](#Функция-CASE-в-MySQL)
* [IF](#Функция-IF-в-MySQL)
* [IFNULL](#Функция-IFNULL-в-MySQL)
* [COALESCE](#Функция-COALESCE-в-MySQL)
* [DISTINCT](#Выборка-уникальных-значений-Оператор-DISTINCT)
* [IN](#Операторы-фильтрации)
* [BETWEEN](#Оператор-BETWEEN)
* [LIKE](#Операторы-LIKE-и-REGEXP)
* [REGEXP](#Операторы-LIKE-и-REGEXP)
* [IS NULL](#is-null)
* [ORDER BY](#Сортировка-ORDER-BY)
* [LIMIT](#Получение-диапазона-строк-Оператор-LIMIT)
* [Агрегатные функции](#Агрегатные-функции)
* [GROUP BY](#Группировка)
* [HAVING](#Фильтрация-групп-HAVING)
* [Подзапросы](#Подзапросы)
* [EXISTS](#Оператор-EXISTS)
* [Неявное соединение таблиц](#Неявное-соединение-таблиц)
* [Inner Join](#inner-join)
* [Outer Join](#outer-join)
* [UNION](#union)
* [VIEW](#Представления-VIEW-в-MySQL)
